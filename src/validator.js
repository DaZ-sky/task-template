const default_image = "/data/images/lqip.jpg";
...
function validate_album(data){
    ...
    const album_image = () => {try{return data.album.image[1]['#text']}catch(e){return default_image}};
...
function validate_track(data){
    ...
    const album_image_of_track = ()=>{try{return data.track.album.image[1]['#text']}catch(e){return default_image}};
...
export function validate_data(data, request){
    ...
    console.log(validate_track(data))
...
export function validate_top_tag_album(data){
    ...
    const track_image = ()=>{try{return data.image[1]['#text']}catch(e){return default_image}};
